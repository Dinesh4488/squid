      ...
      <div className="container">
        <div className="header-content">
          <div className="logo">
            ...
            <span className="logo-name">Squid</span>
          </div>
          ...
          {auth ? (
            <div style={{ display: 'flex', gap: 8 }}>
              ...
              <Button variant="primary" size="medium" onClick={handleLogout}>Logout</Button>
            </div>
          ) : (
            <Button variant="primary" size="medium" onClick={() => navigate('/login')}>Log In</Button>
          )}
        </div>
      </div>
    </header>
